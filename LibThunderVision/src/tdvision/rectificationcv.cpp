                                        ...
                                        CvMat *mxRight, CvMat *myRight)
{
    ...
    CvMat v_lR = cvMat(3, 4, CV_64F, c_lR);
    CvMat v_rR = cvMat(3, 4, CV_64F, c_rR);
    ...
    cvInitUndistortRectifyMap(lM, lD, &v_lR, &v_lP, mxLeft, myLeft);
    cvInitUndistortRectifyMap(rM, rD, &v_rR, &v_rP, mxRight, myRight);
...
{      
    ...
    if ( m_camsDesc.hasExtrinsics() )
    {
        ...
        CvMat v_T = cvMat(3, 3, CV_64F, c_R);
        ...
        calibratedRectify(                          
            ...
            &v_F, calibPatternDim, mxLeft, myLeft, mxRight, myRight);
    }
    else
    {
        uncalibrateRectify(
